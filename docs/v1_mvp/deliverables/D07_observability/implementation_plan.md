...
#### [NEW] [03_observability_schema.sql](../../../../infrastructure/database/postgres/03_observability_schema.sql)
...
- Mount the new `03_observability_schema.sql` into the `postgres` container initialization folder.
