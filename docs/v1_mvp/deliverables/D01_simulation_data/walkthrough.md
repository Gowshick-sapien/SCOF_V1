...
- [NEW] [01_init_schema.sql](file:///d:/projects/SCOF_V1/SCOF/infrastructure/database/postgres/01_init_schema.sql)
- [NEW] [docker-compose.yml](file:///d:/projects/SCOF_V1/SCOF/docker-compose.yml)
- [NEW] [pyproject.toml (shared)](file:///d:/projects/SCOF_V1/SCOF/shared/pyproject.toml)
- [NEW] [loader.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/profile/loader.py)
- [NEW] [validators.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/profile/validators.py)
- [NEW] [pyproject.toml (simulation)](file:///d:/projects/SCOF_V1/SCOF/services/simulation/pyproject.toml)
- [NEW] [Dockerfile](file:///d:/projects/SCOF_V1/SCOF/services/simulation/Dockerfile)
- [NEW] [config.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/src/config.py)
- [NEW] [constants.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/src/constants.py)
- [NEW] [entity_generator.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/src/entity_generator.py)
- [NEW] [order_generator.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/src/order_generator.py)
- [NEW] [disruption_generator.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/src/disruption_generator.py)
- [NEW] [db_writer.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/src/db_writer.py)
- [NEW] [main.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/src/main.py)
- [NEW] [verify_d1.py](file:///d:/projects/SCOF_V1/SCOF/scripts/verify_d1.py)
- [NEW] [test_profile_loader.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/tests/test_profile_loader.py)
- [NEW] [test_entity_generator.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/tests/test_entity_generator.py)
- [NEW] [test_disruption_generator.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/tests/test_disruption_generator.py)
- [NEW] [test_end_to_end.py](file:///d:/projects/SCOF_V1/SCOF/services/simulation/tests/test_end_to_end.py)
