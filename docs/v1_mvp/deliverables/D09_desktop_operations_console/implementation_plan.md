...
| File | Change |
|---|---|
| [implementation_plan.md](file:///d:/projects/SCOF_V1/SCOF/docs/v1_mvp/implementation_plan.md) | Update D09 entry: "Frontend Dashboard" -> "SCOF Desktop Operations Console." Update technology references. Update dependency graph and summary table. |
| [srs.md](file:///d:/projects/SCOF_V1/SCOF/docs/v1_mvp/srs.md) | Update Section 3.9 (FR-9.x): revised requirements per Section 12.1 of this document. Update Section 4.1: "Desktop application (Tauri v2 + React + TypeScript)" instead of "Web dashboard (React/Next.js) accessible via browser." |
