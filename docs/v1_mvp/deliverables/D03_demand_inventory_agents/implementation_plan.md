...
> - **Domain Profile**: [`profiles/mvp-electronics/`](file:///d:/projects/SCOF_V1/SCOF/profiles/mvp-electronics/) is complete with `topology.yaml`, `disruptions.yaml`, and `agents.yaml`.
...
#### [NEW] [structured_claim.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/schemas/structured_claim.py)
...
#### [NEW] [evidence.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/schemas/evidence.py)
...
#### [NEW] [agent_card.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/schemas/agent_card.py)
...
#### [NEW] [scenario_context.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/schemas/scenario_context.py)
...
#### [NEW] [\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/schemas/__init__.py)
...
#### [NEW] [\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/ml/__init__.py)
...
#### [NEW] [types.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/ml/types.py)
...
#### [NEW] [confidence.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/ml/confidence.py)
...
#### [NEW] [ensemble.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/ml/ensemble.py)
...
#### [NEW] [base_model.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/ml/base_model.py)
...
#### [NEW] [feature_scaler.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/ml/feature_scaler.py)
...
#### [NEW] [agents_config.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/profile/agents_config.py)
...
#### [MODIFY] [loader.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/profile/loader.py)
...
#### [MODIFY] [\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/profile/__init__.py)
...
#### [NEW] [\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/agent_base/__init__.py)
- Re-exports `BaseAgent`, `ClaimBuilder`.

#### [NEW] [base_agent.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/agent_base/base_agent.py)
...
#### [NEW] [claim_builder.py](file:///d:/projects/SCOF_V1/SCOF/shared/scof_shared/agent_base/claim_builder.py)
...
#### [NEW] [pyproject.toml](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/pyproject.toml)
...
#### [NEW] [Dockerfile](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/Dockerfile)
...
#### [NEW] [src/\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/__init__.py)
- Package marker.

#### [NEW] [src/config.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/config.py)
...
#### [NEW] [src/main.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/main.py)
...
#### [NEW] [src/agent.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/agent.py)
...
#### [NEW] [src/data_access.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/data_access.py)
...
#### [NEW] [src/features.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/features.py)
...
#### [NEW] [src/mcp/\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/mcp/__init__.py)
- Package marker.

#### [NEW] [src/mcp/tools.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/mcp/tools.py)
...
#### [NEW] [src/models/\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/models/__init__.py)
- Package marker.

#### [NEW] [src/models/xgboost_model.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/models/xgboost_model.py)
...
#### [NEW] [src/models/statistical_model.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/models/statistical_model.py)
...
#### [NEW] [src/models/ensemble.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/src/models/ensemble.py)
...
#### [NEW] [pyproject.toml](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/pyproject.toml)
- Same dependency set as Demand Agent.

#### [NEW] [Dockerfile](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/Dockerfile)
- Python 3.11-slim. Exposes port 8012. Entrypoint: `uvicorn src.main:app --host 0.0.0.0 --port 8012`.

#### [NEW] [src/\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/__init__.py)
- Package marker.

#### [NEW] [src/config.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/config.py)
...
#### [NEW] [src/main.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/main.py)
...
#### [NEW] [src/agent.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/agent.py)
...
#### [NEW] [src/data_access.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/data_access.py)
...
#### [NEW] [src/features.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/features.py)
...
#### [NEW] [src/mcp/\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/mcp/__init__.py)
- Package marker.

#### [NEW] [src/mcp/tools.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/mcp/tools.py)
...
#### [NEW] [src/models/\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/models/__init__.py)
- Package marker.

#### [NEW] [src/models/xgboost_model.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/models/xgboost_model.py)
...
#### [NEW] [src/models/statistical_model.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/models/statistical_model.py)
- `InventoryStatisticalTrainer` / `InventoryStatisticalInference` -- trend + seasonality decomposition on stock level time-series.

#### [NEW] [src/models/ensemble.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/src/models/ensemble.py)
...
#### [NEW] [scripts/verify_d3.py](file:///d:/projects/SCOF_V1/SCOF/scripts/verify_d3.py)
...
#### [NEW] [services/agents/demand/tests/\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/tests/__init__.py)
- Package marker.

#### [NEW] [services/agents/demand/tests/test_demand_agent.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/tests/test_demand_agent.py)
...
#### [NEW] [services/agents/demand/tests/test_demand_ensemble.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/tests/test_demand_ensemble.py)
...
#### [NEW] [services/agents/demand/tests/test_demand_features.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/tests/test_demand_features.py)
- Unit tests for `DemandFeatureBuilder`: feature column names, rolling average correctness, disruption feature injection.

#### [NEW] [services/agents/demand/tests/test_demand_data_access.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/demand/tests/test_demand_data_access.py)
- Integration tests for `DemandDataAccess` queries against a test database (or mocked cursor). Verifies query_hash generation.

#### [NEW] [services/agents/inventory/tests/\_\_init\_\_.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/tests/__init__.py)
- Package marker.

#### [NEW] [services/agents/inventory/tests/test_inventory_agent.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/tests/test_inventory_agent.py)
...
#### [NEW] [services/agents/inventory/tests/test_inventory_ensemble.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/tests/test_inventory_ensemble.py)
- Unit tests for `InventoryEnsemble`.

#### [NEW] [services/agents/inventory/tests/test_inventory_features.py](file:///d:/projects/SCOF_V1/SCOF/services/agents/inventory/tests/test_inventory_features.py)
- Unit tests for `InventoryFeatureBuilder`: depletion rate, days-of-supply, safety stock breach countdown.

---

### Deliverable Documentation (`docs/v1_mvp/deliverables/D03_demand_inventory_agents/`)

#### [MODIFY] [README.md](file:///d:/projects/SCOF_V1/SCOF/docs/v1_mvp/deliverables/D03_demand_inventory_agents/README.md)
- Updated overview, prerequisites, document map, module structure, and definition of done.

#### [NEW] [implementation_plan.md](file:///d:/projects/SCOF_V1/SCOF/docs/v1_mvp/deliverables/D03_demand_inventory_agents/implementation_plan.md)
- This document, copied to the deliverable's documentation directory.

#### [NEW] [demand_agent_design.md](file:///d:/projects/SCOF_V1/SCOF/docs/v1_mvp/deliverables/D03_demand_inventory_agents/demand_agent_design.md)
...
#### [NEW] [inventory_agent_design.md](file:///d:/projects/SCOF_V1/SCOF/docs/v1_mvp/deliverables/D03_demand_inventory_agents/inventory_agent_design.md)
...
#### [NEW] [model_evaluation.md](file:///d:/projects/SCOF_V1/SCOF/docs/v1_mvp/deliverables/D03_demand_inventory_agents/model_evaluation.md)
...
#### [NEW] [acceptance_evidence.md](file:///d:/projects/SCOF_V1/SCOF/docs/v1_mvp/deliverables/D03_demand_inventory_agents/acceptance_evidence.md)
