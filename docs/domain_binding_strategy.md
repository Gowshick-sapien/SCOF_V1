...
|     use (map coordinates, heatmap dimensions, entity display names)         |
+=============================================================================+
```
...
|                                                             |
|  +-------------------------------------------------------+  |
|  | Domain Profile: "acme-electronics"                    |  |
|  | (Single profile loaded at initialization)             |  |
|  +-------------------------------------------------------+  |
+-------------------------------------------------------------+
```
...
|  +---------------------------+  +------------------------+  |
|  | Profile A:                |  | Profile B:             |  |
|  | "electronics-southeast"   |  | "pharma-cold-chain"    |  |
|  +---------------------------+  +------------------------+  |
|               ▲                                             |
|               └────── (Active Profile: [A] switchable at    |
|                        startup or runtime via API/env)      |
+-------------------------------------------------------------+
```
...
|  | Own data stores     |   | Own data stores     |   | Own data stores   |  |
|  +---------------------+   +---------------------+   +-------------------+  |
+-----------------------------------------------------------------------------+
```
