...
class EvidenceItem(BaseModel):
    ...
    type: Literal["historical_data", "model_output", "graph_query", "external_signal"] = Field(
    ...
    reference_id: str = Field(
        ..., description="Machine-traceable identifier (e.g. inventory_level:4567, shipment:882)"
    )
    query_hash: Optional[str] = Field(
        None, description="SHA-256 hash of the query or calculation that generated this evidence"
    )
